  ...
  return [
      ...
      : []),
    {
      ...
      items: [
        ...
        {
          title: t('models.video.items.kling26.title'),
          description: t('models.video.items.kling26.description'),
          icon: <FilmIcon className="size-4 shrink-0" />,
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: t('models.image.items.gptImage15.title'),
          description: t('models.image.items.gptImage15.description'),
          icon: <ImageIcon className="size-4 shrink-0" />,
          href: Routes.MediaStudioGptImage15,
          external: false,
        },
        {
          title: t('models.image.items.zImage.title'),
          description: t('models.image.items.zImage.description'),
          icon: <ImageIcon className="size-4 shrink-0" />,
          href: Routes.MediaStudioZImage,
          external: false,
        },
        {
          title: t('models.image.items.nanoBananaPro.title'),
          description: t('models.image.items.nanoBananaPro.description'),
          icon: <ImageIcon className="size-4 shrink-0" />,
