...
export async function generateMetadata({
  ...
  return constructMetadata({
    ...
    locale,
    pathname: '/media-studio/kling-2-6',
  });
}

export default async function Kling26StudioPage() {
  const t = await getTranslations('Kling26StudioPage');
