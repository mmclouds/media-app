...
export async function generateMetadata({
  ...
  const pt = await getTranslations({
    locale,
    namespace: 'NanoBananaProStudioPage',
  });
  ...
  return constructMetadata({
    ...
    locale,
    pathname: '/media-studio/nano-banana-pro',
  });
}

export default async function NanoBananaProStudioPage() {
  const t = await getTranslations('NanoBananaProStudioPage');
  ...
  const exampleItems: ImageToMediaExample[] = [
    {
      ...
      inputImages: [
        '/images/studio-examples/nano-banana-pro/input-1.png',
        '/images/studio-examples/nano-banana-pro/input-2.png',
      ],
      output: '/images/studio-examples/nano-banana-pro/output-1.jpg',
    },
    {
      ...
      inputImages: [],
      output: '/images/studio-examples/nano-banana-pro/output-2.png',
    },
  ];
